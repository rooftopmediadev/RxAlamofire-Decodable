...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of RxAlamofire-Decodable.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Arnaud Dorgans/RxAlamofire-Decodable'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Arnaud Dorgans' => 'arnaud.dorgans@gmail.com' }
  s.source           = { :git => 'https://github.com/Arnaud Dorgans/RxAlamofire-Decodable.git', :tag => s.version.to_s }
